...
OU.activity.SimpleSearch = function(data, instance, controller) {
	OU.activity.SimpleSearch.prototype.canvasView = function() {
	...
	OU.activity.SimpleSearch.prototype.loadStep = function(step) {
	 ...
	 */
	OU.activity.SimpleSearch.prototype.padArray = function(a, len, val) {
		while (a.length < len) {
			a.push(val);
		}
		return a.slice(0);
	 ...
	 */
	OU.activity.SimpleSearch.prototype.filterArray = function(a, val) {
		var b = [];
	...
	OU.activity.SimpleSearch.prototype.refresh = function(self, obj, colorMap) {
	 ...
	 */
	OU.activity.SimpleSearch.prototype.setAnimation = function(txt, x1, y1, x2, y2, layer, highlight) {
	 ...
	 */
	OU.activity.SimpleSearch.prototype.animate = function(self, layer, highlight) {
	...
	OU.activity.SimpleSearch.prototype.clearAnimation = function(layer) {
		this.animations[layer] = { };
	};

	OU.activity.SimpleSearch.prototype.initControls = function() {
	 ...
	 */
	OU.activity.SimpleSearch.prototype.getDnaFragment = function() {
	...
	OU.activity.SimpleSearch.prototype.getRandomizedSteps = function() {
		...
		for (var i = 0; i < 18; i++) {
			...
			t.push((i < targetLength) ? this.getDnaFragment() : -1);
		}
		...
		var step = {
			...
			auxLabel : "",
			description : "<h3>Simple string searching with randomised search and target strings</h3><p>Reset the visualisation to generate new randomised search and target strings.</p>"
		};
		steps.push(step);
	...
	OU.activity.SimpleSearch.prototype.prevButtonPressed = function() {
	...
	OU.activity.SimpleSearch.prototype.nextButtonPressed = function() {
	...
	OU.activity.SimpleSearch.prototype.resetButtonPressed = function() {
		this.globalStepIndex = 0;
	...
	OU.activity.SimpleSearch.prototype.randomButtonPressed = function() {
		this.shuffleOnReset = !this.shuffleOnReset;
		this.prevButton.disable();
		this.nextButton.disable();
	};

	OU.activity.SimpleSearch.prototype.audioButtonPressed = function() {
	...
	OU.activity.SimpleSearch.prototype.accessibleView = function() {
		OU.activity.SimpleSearch.superClass_.accessibleView.call(this);
	};

	OU.activity.SimpleSearch.prototype.resize = function() {
		var bh = OU.controlHeight;

		OU.activity.SimpleSearch.superClass_.resize.call(this);
	...
	OU.activity.SimpleSearch.prototype.render = function() {
		...
		this.searchArrayAdjY = this.h * 0.4;
	 ...
	 */
	OU.activity.SimpleSearch.prototype.renderArrays = function() {
	...
	OU.activity.SimpleSearch.prototype.renderAnimation = function(layer) {
	...
	OU.activity.SimpleSearch.prototype.remove = function() {
		OU.activity.SimpleSearch.superClass_.remove.call(this);
	};

	OU.activity.SimpleSearch.prototype.showMessage = function(buffer) {
	...
	OU.activity.SimpleSearch.prototype.getColorHexHSV = function(h, s, v) {
		var r, g, b;
		var i;
		var f, p, q, t;
...
OU.inherits(OU.activity.SimpleSearch, OU.util.Activity);
