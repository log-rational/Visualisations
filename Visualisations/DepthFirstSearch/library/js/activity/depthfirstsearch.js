...
/**
 * @class DepthFirstSearch - A template for activities that extend the OU.util.Activity class
 ...
 */
OU.activity.DepthFirstSearch = function (data, instance, controller) {
    /**
     ...
     * </ul>
     */
    OU.activity.DepthFirstSearch.prototype.canvasView = function () {
    ...
    OU.activity.DepthFirstSearch.prototype.playAudio = function (audioFile) {
        if (this.audioPlay) {
    ...
    OU.activity.DepthFirstSearch.prototype.setAnimationSteps = function (steps) {
    ...
    OU.activity.DepthFirstSearch.prototype.initDisplacements = function () {
        var i, inc,
    ...
    OU.activity.DepthFirstSearch.prototype.initControls = function () {
        var self = this,
            bH = OU.controlHeight,
            btnSpace = 100 / 4,
    ...
    OU.activity.DepthFirstSearch.prototype.resetAnimation  = function () {
    ...
    OU.activity.DepthFirstSearch.prototype.initVisualisation = function () {
        this.nodes = data.nodes;
        this.connections = data.connections;
        this.initNodes();
    };

    OU.activity.DepthFirstSearch.prototype.initNodes = function () {
        var key, node;
    ...
    OU.activity.DepthFirstSearch.prototype.initNodeDimensions = function () {
        var key,
            node;
    ...
    OU.activity.DepthFirstSearch.prototype.setNodeDimensions = function () {
     ...
     * The main renderer.
     */
    OU.activity.DepthFirstSearch.prototype.render = function () {
        this.drawVisualisation();
    };

    OU.activity.DepthFirstSearch.prototype.drawVisualisation = function () {
    ...
    OU.activity.DepthFirstSearch.prototype.drawStack = function () {
        ...
        this.drawQueue(ctx, x1, y2, boxWidth, boxWidth);

        ctx.restore(); // restore the context to previous
    };

    OU.activity.DepthFirstSearch.prototype.drawQueue = function (ctx, x1, y1, boxWidth, boxHeight) {
        var i,
            textW,
            letter,
            xOld,
            ...
            queueOldLength = this.queueOld.length,
            moveStep;
        ...
        if (this.animating > -1) {
            ...
            for (i = 0; i < queueLength; i++) {
                ...
                if (index !== -1) {
                    xOld = x1;
                    yOld = y1 - (queueOldLength - index) * boxHeight;
                } else {
                ...
                xNew = x1;
                yNew = y1 - (queueLength - i) * boxHeight;
            ...
            if (this.queue.indexOf(letter) === -1) {
                ...
                xOld = x1;
                yOld = y1 - queueOldLength * boxHeight;
                xNew = x1 + boxWidth;
                yNew = yOld;
                xPos = xOld + (xNew - xOld) * moveStep;
                yPos = yOld + (yNew - yOld) * moveStep;
            ...
            for (i = 0; i < queueLength; i++) {
                ...
                textW = ctx.measureText(letter).width / 2;
                ctx.fillText(letter, x1 - textW, y1 - (queueLength - i) * boxWidth);
            }
        }
    };

    OU.activity.DepthFirstSearch.prototype.drawWaves = function () {
        var i,
            ctx = this.visualisationLayer.context; // get the graphics context
    ...
    OU.activity.DepthFirstSearch.prototype.drawWave = function (ctx, wave) {
    ...
    OU.activity.DepthFirstSearch.prototype.getXPos = function (x) {
        return x / 845 * this.visualisationLayer.w;
    };

    OU.activity.DepthFirstSearch.prototype.getYPos = function (y) {
        return y / 383 * this.visualisationLayer.h;
    };

    OU.activity.DepthFirstSearch.prototype.drawNode = function (nodeName, number, glow) {
        var ctx = this.visualisationLayer.context, // get the graphics context
            alpha,
        ...
        if (this.showOrder) {
            ...
            order = data.order[nodeName];
            textW = ctx.measureText(order).width / 2;
            ctx.fillText(order, x - textW, y + radius * 1.5);
        }
    ...
    OU.activity.DepthFirstSearch.prototype.drawConnection = function (nodeNames, highlight) {
        var ctx = this.visualisationLayer.context, // get the graphics context
    ...
    OU.activity.DepthFirstSearch.prototype.getNodeFontSize = function () {
        return Math.min(this.nodeSize * 0.8);
    };

    // caclulate all swaps and then start the replacy of the steps of the algorithm
    OU.activity.DepthFirstSearch.prototype.start = function () {
        this.backBtn.enable();
    ...
    OU.activity.DepthFirstSearch.prototype.recordSearch = function () {
        var i, datum, key;
    ...
    OU.activity.DepthFirstSearch.prototype.renderLoop = function () {
        var self = this;
        if (!this.dead) {
            this.drawVisualisation();
            if (this.animating > -1) {
    ...
    OU.activity.DepthFirstSearch.prototype.step = function () {
    ...
    OU.activity.DepthFirstSearch.prototype.replaySearch = function () {
        var replay, action;
    ...
    OU.activity.DepthFirstSearch.prototype.doAction = function (action) {
        var key, node;
    ...
    OU.activity.DepthFirstSearch.prototype.playIt = function (text, audio, pageNumber) {
    ...
    OU.activity.DepthFirstSearch.prototype.next = function () {
        if (this.dead) {
            this.start();
        }
    ...
    OU.activity.DepthFirstSearch.prototype.back = function () {
    ...
    OU.activity.DepthFirstSearch.prototype.animatingFinished = function () {
        if (this.action2) {
    ...
    OU.activity.DepthFirstSearch.prototype.toggleAudio = function () {
     ...
     */
    OU.activity.DepthFirstSearch.prototype.accessibleView = function () {
        OU.activity.DepthFirstSearch.superClass_.accessibleView.call(this); // call the superclass method is you want to extend it, remove this line to override the method instead
     ...
     * </ul>
     */
    OU.activity.DepthFirstSearch.prototype.resize = function () {
        OU.activity.DepthFirstSearch.superClass_.resize.call(this); // call the superclass resize
    ...
    OU.activity.DepthFirstSearch.prototype.getFontSize = function () {
     ...
     */
    OU.activity.DepthFirstSearch.prototype.remove = function () {
        OU.activity.DepthFirstSearch.superClass_.remove.call(this); // call the superclass remove
...
OU.inherits(OU.activity.DepthFirstSearch, OU.util.Activity);