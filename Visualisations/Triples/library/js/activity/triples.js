...
/**
 * @class Triples - A template for activities that extend the OU.util.Activity class
 ...
 */
OU.activity.Triples = function (data, instance, controller) {
    /**
     ...
     * </ul>
     */
    OU.activity.Triples.prototype.canvasView = function () {
    ...
    OU.activity.Triples.prototype.playAudio = function (audioFile) {
        if (this.audioPlay) {
    ...
    OU.activity.Triples.prototype.setAnimationSteps = function (steps) {
    ...
    OU.activity.Triples.prototype.initDisplacements = function () {
        var i, inc,
    ...
    OU.activity.Triples.prototype.initControls = function () {
        var self = this,
            bH = OU.controlHeight,
            btnSpace = 100 / 4,
    ...
    OU.activity.Triples.prototype.resetAnimation  = function () {
        this.orderLast = -1;
    ...
    OU.activity.Triples.prototype.setNodeDimensions = function () {
        var pad,
     ...
     * The main renderer.
     */
    OU.activity.Triples.prototype.render = function () {
        this.drawVisualisation();
    };

    OU.activity.Triples.prototype.drawVisualisation = function () {
    ...
    OU.activity.Triples.prototype.drawTable = function () {
    ...
    OU.activity.Triples.prototype.drawBorders = function (ctx, i, x1, x2, y1, y2, boxWidth, boxHeight, lineSize) {
    ...
    OU.activity.Triples.prototype.drawPair = function (ctx, i, j, x, y, boxWidth, boxHeight, isLast, highlight, fadeIn) {
        var textW,
            i,
            fontSize = this.getNodeFontSize(),
            text = isLast ? "..." : data.pairs[j - 1].substring(0, 4) + "," + i + ")",
    ...
    OU.activity.Triples.prototype.drawIndex = function (ctx, index, x, y, boxWidth, boxHeight, highlight, fadeIn) {
        var text = index;
    ...
    OU.activity.Triples.prototype.drawText = function (ctx, text, x, y, fadeIn, highlight) {
        var textW,
            fontSize = this.getNodeFontSize();
    ...
    OU.activity.Triples.prototype.drawCurrent = function (ctx, i, j, x, y, boxWidth, boxHeight) {
        ...
        if (order <= currentOrder) {
            ...
            if (isCurrent && order != this.orderLast) {
                this.textDiv.div.innerHTML += "<br/><br/>" + order + " " +  data.pairs[j - 1].substring(0, 4) +
                                                "," + i + ")";
    ...
    OU.activity.Triples.prototype.drawHeadings = function (ctx, letter, index, x, y, pairCount, boxWidth, boxHeight) {
        var text,
            textW,
            isVisible = false,
            which,
        ...
        text = index === 0 ? "" : index >= pairCount ? "..." : letter === "a" ? data.pairs[index - 1] : index;
        textW = ctx.measureText(text).width / 2;
    ...
    OU.activity.Triples.prototype.drawTextBox = function (ctx, text, x, y, boxWidth, boxHeight,
    ...
    OU.activity.Triples.prototype.drawHighlight = function (ctx, x, y, boxWidth, boxHeight, highlight) {
    ...
    OU.activity.Triples.prototype.getXPos = function (x) {
        return x / 845 * this.visualisationLayer.w;
    };

    OU.activity.Triples.prototype.getYPos = function (y) {
        return y / 383 * this.visualisationLayer.h;
    };

    OU.activity.Triples.prototype.getNodeFontSize = function () {
        return Math.min(this.nodeSize * 0.8);
    };

    // caclulate all swaps and then start the replacy of the steps of the algorithm
    OU.activity.Triples.prototype.start = function () {
        this.backBtn.enable();
    ...
    OU.activity.Triples.prototype.recordSearch = function () {
        var i,
            datum,
            key,
            similar = 0,
    ...
    OU.activity.Triples.prototype.renderLoop = function () {
        var self = this;
        if (!this.dead) {
            this.drawVisualisation();
            if (this.animating > -1) {
    ...
    OU.activity.Triples.prototype.step = function () {
    ...
    OU.activity.Triples.prototype.replaySearch = function () {
        var replay;
    ...
    OU.activity.Triples.prototype.animatingFinished = function () {
    ...
    OU.activity.Triples.prototype.doAction = function () {
    ...
    OU.activity.Triples.prototype.playIt = function (text, audio, pageNumber) {
        if (audio !== "") {
    ...
    OU.activity.Triples.prototype.next = function () {
        if (this.dead) {
            this.start();
        }
    ...
    OU.activity.Triples.prototype.back = function () {
    ...
    OU.activity.Triples.prototype.toggleAudio = function () {
     ...
     */
    OU.activity.Triples.prototype.accessibleView = function () {
        OU.activity.Triples.superClass_.accessibleView.call(this); // call the superclass method is you want to extend it, remove this line to override the method instead
     ...
     * </ul>
     */
    OU.activity.Triples.prototype.resize = function () {
        OU.activity.Triples.superClass_.resize.call(this); // call the superclass resize
    ...
    OU.activity.Triples.prototype.getFontSize = function () {
     ...
     */
    OU.activity.Triples.prototype.remove = function () {
        OU.activity.Triples.superClass_.remove.call(this); // call the superclass remove
...
OU.inherits(OU.activity.Triples, OU.util.Activity);